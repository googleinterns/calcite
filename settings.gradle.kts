...
include(
    ...
    "mongodb",
    "parsing",
    "parsing:intermediate:dialects:bigquery",
    "parsing:intermediate:dialects:defaultdialect",
    "parsing:intermediate:dialects:dialect1",
    "parsing:intermediate:dialects:hive",
    "parsing:intermediate:dialects:mysql",
