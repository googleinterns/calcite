...
include(
    ...
    "mongodb",
    "parsing",
    "parsing:dialects:intermediate:dialects:bigquery",
    "parsing:dialects:intermediate:dialects:defaultdialect",
    "parsing:dialects:intermediate:dialects:dialect1",
    "parsing:dialects:intermediate:dialects:hive",
    "parsing:dialects:intermediate:dialects:mysql",
    "parsing:dialects:intermediate:dialects:postgresqlBase",
    "parsing:dialects:intermediate:dialects:postgresqlBase:dialects:postgresql",
    "parsing:dialects:intermediate:dialects:postgresqlBase:dialects:redshift",
    "parsing:tools",
    "pig",
    "piglet",
    "plus",
