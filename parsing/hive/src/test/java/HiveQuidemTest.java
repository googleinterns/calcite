...
import org.apache.calcite.sql.parser.Hive.SqlHiveParserImpl;
...
/**
 * Unit tests for the Hive SQL parser.
 */
class HiveQuidemTest extends QuidemTest {
  /** Runs a test from the command line.
   *
   * <p>For example:
   *
   * <blockquote>
   *   <code>java HiveQuidemTest sql/table.iq</code>
   * </blockquote> */
  public static void main(String[] args) throws Exception {
    for (String arg : args) {
      new HiveQuidemTest().test(arg);
    }
  }
        ...
        case "scott-hive":
          return CalciteAssert.that()
              ...
              .with(CalciteConnectionProperty.PARSER_FACTORY,
                  HiveParserImpl.class.getName() + "#FACTORY")
      ...
      if (execute) {
        ...
        final SqlParser.ConfigBuilder parserConfig =
            SqlParser.configBuilder()
                .setParserFactory(HiveParserImpl.FACTORY);
  ...
  private static class HiveCommandHandler implements CommandHandler {
