...
/**
 * Unit tests for the Redshift SQL parser.
 */
class RedshiftQuidemTest extends QuidemTest {
  ...
  @Override protected CommandHandler createCommandHandler() {
    return new RedshiftCommandHandler();
  }
      ...
      if (execute) {
        ...
        final SqlParser.ConfigBuilder parserConfig =
            SqlParser.configBuilder()
                .setParserFactory(RedshiftParserImpl.FACTORY);
  ...
  private static class RedshiftCommandHandler implements CommandHandler {
