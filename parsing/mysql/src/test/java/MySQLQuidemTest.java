...
/**
 * Unit tests for the MySQL SQL parser.
 */
class MySQLQuidemTest extends QuidemTest {
      ...
      if (execute) {
        ...
        final SqlParser.ConfigBuilder parserConfig =
            SqlParser.configBuilder()
                .setParserFactory(MySQLQuidemTest.FACTORY);
  ...
  private static class MySQLCommandHandler implements CommandHandler {
