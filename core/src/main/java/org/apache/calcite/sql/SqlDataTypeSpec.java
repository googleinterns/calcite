...
public class SqlDataTypeSpec extends SqlNode {
  ...
  public SqlDataTypeSpec(
      ...
      SqlParserPos pos) {
    this(typeNameSpec, /*timeZone=*/ null, /*nullable=*/ null, /*uppercase=*/ null, /*caseSpecific=*/ null, pos);
  }
  ...
  public SqlDataTypeSpec(
      ...
      TimeZone timeZone,
      SqlParserPos pos) {
    this(typeNameSpec, timeZone, /*nullable=*/ null, /*uppercase=*/ null, /*caseSpecific=*/ null, pos);
  }
  ...
  public SqlDataTypeSpec withNullable(Boolean nullable) {
    ...
    return new SqlDataTypeSpec(typeNameSpec, timeZone, nullable, uppercase, caseSpecific, getParserPosition());
  }
