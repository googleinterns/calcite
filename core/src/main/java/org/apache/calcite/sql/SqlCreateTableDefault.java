 ...
 */
public class SqlCreateTableDefault extends SqlCreateTable {

  private static final SqlOperator OPERATOR =
      new SqlSpecialOperator("CREATE TABLE", SqlKind.CREATE_TABLE);

  /** Creates a SqlCreateTableDefault. */
  SqlCreateTableDefault(SqlParserPos pos, SqlCreateSpecifier createSpecifier,
